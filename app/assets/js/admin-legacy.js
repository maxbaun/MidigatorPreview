...
var FileUpload = function() {
    ...
    var _componentFileUpload = function() {
        ...
        $('.file-input-preview').fileinput({
            ...
            initialPreview: [
                '../assets/img/altoram-logo.png'
            ],
            initialPreviewConfig: [
                {caption: 'AltoRAM-logo.png', size: 31000, key: 1, url: '{$url}', showDrag: false}
            ],
...
var NotyJgrowl = function() {
    ...
    var _componentNoty = function() {
        ...
        // Success
        $('.noty_seller_id_added').on('click', function() {
            new Noty({
                text: 'The Seller ID {order_insight_seller_id} has been added',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_member_id_added').on('click', function() {
            new Noty({
                text: 'The Member ID {eliminator_member_id} has been added',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_seller_id_deleted').on('click', function() {
            new Noty({
                text: 'The Seller ID {order_insight_seller_id} has been deleted',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_member_id_deleted').on('click', function() {
            new Noty({
                text: 'The Member ID {eliminator_member_id} has been deleted',
                type: 'success'
            }).show();
        });
