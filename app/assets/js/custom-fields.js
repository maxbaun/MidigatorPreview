...
var NotyJgrowl = function() {
    ...
    var _componentNoty = function() {
        ...
        // Success
        $('.noty_changes_saved').on('click', function() {
            new Noty({
        ...
        // Success
        $('.noty_field_created').on('click', function() {
            new Noty({
                text: 'The custom field has been created.',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_field_deleted').on('click', function() {
            new Noty({
                text: 'The custom field has been deleted.',
                type: 'success'
            }).show();
        });
...
var InputsCheckboxesRadios = function () {
    ...
    var _componentSwitchery = function() {
        ...
        var midigreen = document.querySelector('.form-check-input-switchery-midigreen');
        var switchery = new Switchery(midigreen, { color: '#afd25c' });

        var midigreen2 = document.querySelector('.form-check-input-switchery-midigreen2');
        var switchery = new Switchery(midigreen2, { color: '#afd25c' });

        var midigreen3 = document.querySelector('.form-check-input-switchery-midigreen3');
        var switchery = new Switchery(midigreen3, { color: '#afd25c' });
