    ...
    var _componentFileUpload = function() {
        ...
        $('.file-input-overwrite').fileinput({
            ...
            initialPreview: [
                ...
                '../../assets/img/shipping-2.png',
                '../../assets/img/billing.png'
            ],
            initialPreviewConfig: [
                {caption: 'Shipping-info.png', size: 930321, key: 1, url: '{$url}'},
                {caption: 'Shipping-address.png', size: 1218822, key: 2, url: '{$url}'},
                {caption: 'Payment-info.png', size: 123862, key: 3, url: '{$url}'}
            ],
            initialPreviewAsData: true,
            overwriteInitial: false,
            previewZoomButtonClasses: previewZoomButtonClasses,
...
var NotyJgrowl = function() {
    ...
    var _componentNoty = function() {
        ...
        // Success
        $('#noty_save_progress').on('click', function() {
            new Noty({
                text: '<strong>Success!</strong> Your progress has been saved.',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_load_section').on('click', function() {
            new Noty({
                text: '<strong>Success!</strong> A new saved section has been loaded into your dispute response.',
                type: 'success'
            }).show();
        });
        ...
        // Success
        $('#noty_save_section').on('click', function() {
            new Noty({
                text: '<strong>Success!</strong> The new section has been saved.',
                type: 'success'
            }).show();
        });
