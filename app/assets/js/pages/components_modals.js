...
$(function() {
    ...
    $('.sweet_success').on('click', function() {
        swal({
            title: "Success!",
            text: "Your infomation has been saved",
    ...
    $('.sweet_combine').on('click', function() {
     ...
     // Alert combination
    $('.sweet_save_cancel').on('click', function() {
        swal({
            title: "Are you sure?",
            text: "You will not be able to recover this information!",
            type: "warning",
    ...
    // Alert combination
    $('.archive_ad_account').on('click', function() {
        swal({
        ...
        function(isConfirm){
            if (isConfirm) {
                swal({
                    title: "Success!",
                    text: "The information has been archived.",
                    confirmButtonColor: "#66BB6A",
                    type: "success"
                });
            }
                ...
                swal({
                    title: "Cancelled",
                    text: "The account is still active",
                    confirmButtonColor: "#2196F3",
                    type: "error"
                });
            }
    ...
    // Alert combination
    $('.archive_partner').on('click', function() {
        swal({
        ...
        function(isConfirm){
            if (isConfirm) {
                swal({
                    title: "Success!",
                    text: "The partner has been archived.",
                    confirmButtonColor: "#66BB6A",
                    type: "success"
                });
            }
                ...
                swal({
                    title: "Cancelled",
                    text: "The partner is still active",
                    confirmButtonColor: "#2196F3",
                    type: "error"
                });
            }
    ...
    // Alert combination
    $('.archive_partner_group').on('click', function() {
        swal({
            title: "Are you sure you want to archive this partner group?",
            text: "",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#EF5350",
        ...
        function(isConfirm){
            if (isConfirm) {
                swal({
                    title: "Success!",
                    text: "The group has been archived.",
                    confirmButtonColor: "#66BB6A",
                    type: "success"
                });
            }
                ...
                swal({
                    title: "Cancelled",
                    text: "The group is still active",
                    confirmButtonColor: "#2196F3",
                    type: "error"
                });
            }
