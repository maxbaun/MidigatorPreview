...
var NotyJgrowl = function() {
    ...
    var _componentNoty = function() {
        ...
        // Success
        $('#noty_alert_resolved').on('click', function() {
            new Noty({
                text: '<strong>Success!</strong> The alert has been resolved',
                type: 'success'
            }).show();
        });

        // Success
        $('#noty_result_update').on('click', function() {
            new Noty({
                text: 'The result for the dispute case has been updated.',
                type: 'success'
            }).show();
        });

        // Success
        $('#noty_feedback_submit').on('click', function() {
            new Noty({
                text: '<strong>Thank you!</strong> Your feedback has been sent to our product team. You will receive follow-up shortly.',
                type: 'success',
                layout: 'topRight',
            }).show();
        });
        ...
        // Success
        $('.noty_assign_case_success').on('click', function() {
            new Noty({
                text: 'The dispute case was successfully assigned to [user_name]',
                type: 'success',
                layout: 'topRight',
            }).show();
        });
        ...
        // Success
        $('#noty_dnf_success').on('click', function() {
            new Noty({
                text: 'The dispute was marked as <strong>Do Not Fight</strong> and the status was changed to "Completed"',
                type: 'success',
                layout: 'topRight',
            }).show();
        });
...
var DatatableButtonsHtml5 = function() {
    ...
    var _componentDatatableButtonsHtml5 = function() {
        ...
        // Basic initialization
        $('.datatable-button-html5-basic-multi').DataTable({
            columnDefs: [
                {
                    orderable: false,
        ...
        datatable-button-html5-basic-multi.on("click", "th.select-checkbox", function() {
            if ($("th.select-checkbox").hasClass("selected")) {
                datatable-button-html5-basic-multi.rows().deselect();
                $("th.select-checkbox").removeClass("selected");
            } else {
                datatable-button-html5-basic-multi.rows().select();
                $("th.select-checkbox").addClass("selected");
            }
        }).on("select deselect", function() {
            ("Some selection or deselection going on")
            if (datatable-button-html5-basic-multi.rows({
                    selected: true
                }).count() !== datatable-button-html5-basic-multi.rows().count()) {
                $("th.select-checkbox").removeClass("selected");
            } else {
                $("th.select-checkbox").addClass("selected");
            }
