...
$(document).ready(function(){
    $('#chartfilter8').on('change', function() {
      if ( this.value == '3')
      {
        $("#processorfilter8").show();
      }
      else
      {
        $("#processorfilter8").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chartfilter7').on('change', function() {
      if ( this.value == '3')
      {
        $("#processorfilter7").show();
      }
      else
      {
        $("#processorfilter7").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chartfilter6').on('change', function() {
      if ( this.value == '3')
      {
        $("#processorfilter6").show();
      }
      else
      {
        $("#processorfilter6").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chartfilter5').on('change', function() {
      if ( this.value == '3')
      {
        $("#processorfilter5").show();
      }
      else
      {
        $("#processorfilter5").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chartfilter4').on('change', function() {
      if ( this.value == '3')
      {
        $("#processorfilter4").show();
      }
      else
      {
        $("#processorfilter4").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chartfilter3').on('change', function() {
      if ( this.value == '3')
      {
        $("#processorfilter3").show();
      }
      else
      {
        $("#processorfilter3").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chartfilter2').on('change', function() {
      if ( this.value == '3')
      {
        $("#processorfilter2").show();
      }
      else
      {
        $("#processorfilter2").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chartfilter1').on('change', function() {
      if ( this.value == '3')
      {
        $("#processorfilter1").show();
      }
      else
      {
        $("#processorfilter1").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chart-select3').on('change', function() {
      if ( this.value == '8')
      {
        $("#lagtime3").show();
      }
...
$(document).ready(function(){
    $('#chart-select3').on('change', function() {
      if ( this.value == '1')
      {
        $("#marketingsource3").show();
      }
      else
      {
        $("#marketingsource3").hide();
      }
    });
});

$(document).ready(function(){
    $('#chart-select2').on('change', function() {
      if ( this.value == '8')
      {
        $("#lagtime2").show();
      }
...
$(document).ready(function(){
    $('#chart-select2').on('change', function() {
      if ( this.value == '1')
      {
        $("#marketingsource2").show();
      }
      else
      {
        $("#marketingsource2").hide();
      }
    });
});
...
$(document).ready(function(){
    $('#chart-select').on('change', function() {
      if ( this.value == '1')
      {
        $("#marketingsource").show();
      }
      else
      {
        $("#marketingsource").hide();
      }
    });
});
...
var NotyJgrowl = function() {
    ...
    var _componentNoty = function() {
        ...
        // Success
        $('.noty_copy_password').on('click', function() {
            new Noty({
        ...
        // Success
        $('.noty_update_password').on('click', function() {
            new Noty({
        ...
        // Success
        $('.noty_viewable_company_access').on('click', function() {
            new Noty({
                text: 'Success! The user now has viewer access to the selected companies.',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_user_created').on('click', function() {
            new Noty({
        ...
        // Success
        $('.noty_user_deleted').on('click', function() {
            new Noty({
        ...
        // Success
        $('#noty_notification_created').on('click', function() {
            new Noty({
        ...
        // Success
        $('.noty_access_removed').on('click', function() {
            new Noty({
                text: 'The users access to Fresh Flowers has been removed.',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_invite_sent').on('click', function() {
            new Noty({
                text: 'The email invitation has been sent',
                type: 'success'
            }).show();
        });
        ...
        // Success
        $('#noty_user_update').on('click', function() {
            new Noty({
...
var DatatableButtonsHtml5 = function() {
    ...
    var _componentDatatableButtonsHtml5 = function() {
        ...
        // Basic initialization
        $('.datatable-button-html5-no-export').DataTable({
            buttons: {            
                dom: {
                    button: {
                        className: 'btn btn-light'
