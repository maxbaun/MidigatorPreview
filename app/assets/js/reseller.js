...
var Dashboard = function () {
    ...
    return {
        ...
        initCharts: function() {
            ...
            _chartSparkline('#total-online', 'line', 30, 35, 'basis', 750, 2000, '#afd25c');
...
var ExtendedFormControls = function() {
    ...
    var _componentPassy = function() {
        ...
        // Strength meter
        var feedback = [
            {color: '#FF5630', text: 'Weak', textColor: '#fff'},
            {color: '#a3a3a3', text: 'Normal', textColor: '#fff'},
            {color: '#00B8D9', text: 'Good', textColor: '#fff'},
            {color: '#36B37E', text: 'Strong', textColor: '#fff'}
        ];
...
var NotyJgrowl = function() {
    ...
    var _componentNoty = function() {
        ...
        $('.noty_invite_sent').on('click', function() {
            new Noty({
                layout: 'topRight',
                text: 'Invite email has been sent',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_invite_deleted').on('click', function() {
            new Noty({
                layout: 'topRight',
                text: 'The users invite has been deleted',
                type: 'success'
            }).show();
        });
        ...
        $('.noty_access_removed').on('click', function() {
            new Noty({
                layout: 'topRight',
                text: 'The users access has been removed',
                type: 'success'
            }).show();
        });

        // Success
        $('.noty_reactivate_user').on('click', function() {
            new Noty({
                layout: 'topRight',
                text: 'The users access has been restored',
                type: 'success'
            }).show();
        });
        ...
        // Copied
        $('.noty_delete_creds').on('click', function() {
            new Noty({
                layout: 'topRight',
                text: 'API credentials have been deleted',
                type: 'success'
            }).show();
        });
