    ...
    var _barsPiesExamples = function() {
        ...
        if(pie_chart_element) {
            ...
            var pie_chart = c3.generate({
                ...
                size: { width: 350 },
                color: {
                    pattern: ['#3F51B5', '#FF9800', '#36B37E', '#00BCD4', '#F44336']
                },
                data: {
                    columns: [
                        ['data1', 30],
        ...
        if(bar_stacked_chart_element) {
            ...
            var bar_stacked_chart = c3.generate({
                ...
                size: { height: 400 },
                color: {
                    pattern: ['#FF9800', '#F44336', '#009688', '#36B37E']
                },
                data: {
                    columns: [
        ...
        if(combined_chart_element) {
            ...
            var combined_chart = c3.generate({
                ...
                size: { height: 400 },
                color: {
                    pattern: ['#FF9800', '#F44336', '#009688', '#36B37E', '#03A9F4', '#8BC34A']
                },
                data: {
                    columns: [
